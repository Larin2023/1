...
// 2)
            // все необходимые настройки мы сдесь сделали
            //    private static Logger logger = LogManager.getLogger(MainPageLesson12.class);

            //    public MainPageLesson12(WebDriver driver) {
            //        super(driver);
            //    }
            //    I am using "org.apache.logging.log4j2

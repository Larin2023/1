...
// 8)
                // теперь я хочу вот этот элемент отправить текст "cleaning"
                searchField.sendKeys("cleaning");


// 9)
                // дальше я должен нажать кнопку enter
...
// 10)
                // нам надо assert. теперь я должен найти веб элемент ""339 results for""
                WebElement result = driver.findElement(By.tagName("h2"));

// 11)
                // теперь я должен убедиться что tagName содержит 339 результатов

...
//  2)
            //  мы создаем webdriver
                    WebDriver driver = new ChromeDriver();
                    driver.get("https://bbb.testpro.io/");

// 12)
            // нам надо подождать (страницы не успевает открываться)
                    Thread.sleep(1000);
// 6)
...
// 9)
                    //теперь мне надо в email отправить мой email
...
// 13)
                    // последний штрих мы должны подтвердить что мы зашли на страницу
...
// 4)
                // надо поставить add exception to метод signature
                    Thread.sleep(5000);//
// 3)
                    driver.quit();
                }
...
// 17)
                // вместо пароля правильного пароля я отправляю какую bad password

...
// 3)
        ...
        public class UnitTestLesson1 {
            ...
            // Naming convention гласит, название теста вы делите на 3 части.
            // первая часть это то что вы тестируете.
            // я тестирую "ticketsTest".
            // второе это чем вы тестируете.
            // я тестирую "infant".

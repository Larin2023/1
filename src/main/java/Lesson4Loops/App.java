...
//            левой стороны мы пишем переменную того типаю если у нас colors
//            это array из стрингов значит переменная будет string потому что мы получили вот
//            в эту переменную color я ее назову color
        ...
        //то есть в самом начале времен, самый большой это
        //нулевой элемент.
...
//        int[] numbers = {2, 2, 3, 10, 4, 10, 2, 7, 8, 3000, 4, 6, 7, 3, 6, 3};
        int index = 0;
        for (int v5 : numbers) {
            if (v5 == 10) {

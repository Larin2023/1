...
public class App {
    public static void main(String[] args) {
        ...
        // потому что HashSet наследует Set.
        ...
        System.out.println(cities);
//       Advantage of SET:
//      a)Иногда нам надо вытащить только уникальные, или наоборот, вам надо вытащить только повторы.
...
//      b)   можно узнать есть ли это значение или нет
        ...
        //eдинственный из кейсoв где мы можем использовать это. это задачей по интервью!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
